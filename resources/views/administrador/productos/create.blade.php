...
<div class="min-h-screen bg-slate-50 p-4 md:p-6 lg:p-8">
    <div class="max-w-4xl mx-auto space-y-6">
        ...
        <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-6">
            ...
            <span class="text-gray-900 font-medium">Crear Producto</span>
        </nav>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden">
            <div class="p-6 md:p-8">
                <div class="mb-8">
                    <h1 class="text-2xl font-bold text-slate-900">Crear Nuevo Producto</h1>
                    <p class="text-slate-500 mt-2">Complete la información para registrar un nuevo producto para la venta.</p>
                </div>
                ...
                @if($ingreso)
                    <div class="mb-8 bg-blue-50 border border-blue-100 rounded-xl p-4 flex items-start gap-4">
                        ...
                        <div>
                            <h3 class="font-semibold text-blue-900">Creando producto desde lote</h3>
                            <p class="text-blue-700 text-sm mt-1">
                                Se están utilizando datos del lote <strong>{{ $ingreso->nombre_producto }}</strong> de <strong>{{ $ingreso->proveedor->nombre_empresa ?? 'Proveedor' }}</strong>.
                            </p>
                        </div>
                    </div>
                @endif

                <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6" id="productForm">
                    @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Si ya hay una categoría seleccionada (al recargar la página con errores)
