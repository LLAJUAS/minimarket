...
<div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-50 p-4 md:p-6 lg:p-8">
    <div class="max-w-5xl mx-auto space-y-6">
        ...
        <nav class="flex items-center space-x-2 text-sm mb-8">
            ...
            <span class="text-gray-900 font-semibold">Crear Producto</span>
        </nav>
        ...
        <div class="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
            ...
            <div class="bg-green-600 p-8 text-white">
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-green-100 mt-1">Complete la información para registrar un nuevo producto en el inventario</p>
                    </div>
                </div>
            </div>
            ...
            <div class="p-8 md:p-10">
                ...
                @if($ingreso)
                    <div class="mb-8 bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 rounded-xl p-6 shadow-sm">
                        <div class="flex items-start gap-4">
                            ...
                            <div class="flex-1">
                                <h3 class="font-bold text-blue-900 text-lg mb-1">📦 Creando desde lote existente</h3>
                                <p class="text-blue-700">
                                    Se están utilizando datos del lote <span class="font-bold">{{ $ingreso->nombre_producto }}</span> de <span class="font-bold">{{ $ingreso->proveedor->nombre_empresa ?? 'Proveedor' }}</span>
                                </p>
                                <div class="mt-3 flex items-center gap-4 text-sm">
                                    ...
                                    <span class="px-3 py-1 bg-blue-100 text-blue-700 rounded-full font-medium">
                                        Stock: {{ number_format($ingreso->cantidad_inicial, 0, ',', '.') }} {{ $ingreso->unidad_medida }}
                                    </span>
                                </div>
                            </div>
                        </div>
                ...
                <form action="{{ route('productos.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8" id="productForm">
                    @csrf
                    
                    @if($ingreso)
                        <input type="hidden" name="ingreso_producto_id" value="{{ $ingreso->id }}">
                    @endif
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="col-span-2">
                                ...
                                <input type="text" 
                                       name="nombre" 
                                       id="nombre" 
                                       value="{{ old('nombre', $ingreso->nombre_producto ?? '') }}" 
                                       ...
                                       placeholder="Ej: Leche Entera Pil 1L"
                                       required>
                                @error('nombre')
                            ...
                            <div>
                                ...
                                <div class="mt-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                                    <p class="text-xs text-green-700 flex items-center gap-1">
                                        ...
                                        <span class="font-medium">Precio sugerido:</span> 
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                                ...
                                Fotografía del producto <span class="text-red-500">*</span>
                            </label>

                            <input id="imagen" name="imagen" type="file" class="sr-only" accept="image/*" required>

                            <div class="relative mt-1 flex justify-center px-6 pt-8 pb-8 border-3 border-dashed border-gray-300 rounded-2xl hover:border-green-500 hover:bg-green-50/50 transition-all duration-300 cursor-pointer bg-gradient-to-br from-gray-50 to-slate-50" id="image-dropzone">
                                <div class="space-y-2 text-center" id="image-preview">
                                    ...
                                    <div class="flex text-sm text-gray-600 justify-center items-center gap-1">
                                        <label for="imagen" class="relative cursor-pointer bg-white rounded-lg px-3 py-1 font-semibold text-green-600 hover:text-green-500 hover:bg-green-50 transition-all duration-200">
                    ...
                    <div class="flex items-center justify-between gap-4 pt-8 mt-8 border-t-2 border-gray-200">
                        ...
                        <button type="submit" class="flex items-center gap-2 px-8 py-3 text-sm font-bold text-white bg-gradient-to-r from-green-600 to-emerald-600 rounded-xl hover:from-green-700 hover:to-emerald-700 focus:outline-none focus:ring-4 focus:ring-green-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200">
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
